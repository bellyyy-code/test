...
ScriptSense.Config = {
    ...
    Keybinds = {
        ...
        MenuToggle = Enum.KeyCode.F1, -- Меню теперь открывается по F1
    }
}
...
-- Обработка клавиши F1 для открытия/закрытия главного меню
...
-- Исправление вращения (Anti-Aim / Spin), чтобы работало при ShiftLock
